...
OFPT_RULE_MOD = 30   # rule mod message
OFPT_RULE_MOD_REPLY = 31   # rule mod reply message
...
# my code
# enum ofp_rule_mod_command
OFPRC_ADD = 0               # New rule.
OFPRC_MODIFY = 1            # Modify all matching flows.
OFPRC_DELETE = 2            # Delete all matching flows.

_OFP_RULE_MOD_PACK_STR0 = 'HHIII'
OFP_RULE_MOD_PACK_STR = '!' + _OFP_RULE_MOD_PACK_STR0 + _OFP_MATCH_PACK_STR
OFP_RULE_MOD_PACK_STR0 = '!' + _OFP_RULE_MOD_PACK_STR0
OFP_RULE_MOD_SIZE = 32
assert (calcsize(OFP_RULE_MOD_PACK_STR) + OFP_HEADER_SIZE ==
        OFP_RULE_MOD_SIZE)

# OFP_RULE_MOD_PACK_STR = '!II32s'
# OFP_RULE_MOD_SIZE = 48
# assert (calcsize(OFP_RULE_MOD_PACK_STR) + OFP_HEADER_SIZE ==
#         OFP_RULE_MOD_SIZE)

OFP_RULE_MOD_REPLY_PACK_STR = '!II32s'
OFP_RULE_MOD_REPLY_SIZE = 48
assert (calcsize(OFP_RULE_MOD_REPLY_PACK_STR) + OFP_HEADER_SIZE ==
        OFP_RULE_MOD_REPLY_SIZE)
...
oxm_types = [
    ...
    # my code
    oxm_fields.OpenFlowBasic('iptables_s_addr', 60, type_desc.IPv4Addr),
    oxm_fields.OpenFlowBasic('iptables_d_addr', 61, type_desc.IPv4Addr),
    oxm_fields.OpenFlowBasic('iptables_smsk', 62, type_desc.IPv4Addr),
    oxm_fields.OpenFlowBasic('iptables_dmsk', 63, type_desc.IPv4Addr),
    oxm_fields.OpenFlowBasic('iptables_spts0', 64, type_desc.Int2),
    oxm_fields.OpenFlowBasic('iptables_spts1', 65, type_desc.Int2),
    oxm_fields.OpenFlowBasic('iptables_dpts0', 66, type_desc.Int2),
    oxm_fields.OpenFlowBasic('iptables_dpts1', 67, type_desc.Int2),
    oxm_fields.OpenFlowBasic('iptables_proto', 68, type_desc.Int4),
    oxm_fields.OpenFlowBasic('iptables_tablename', 69, type_desc.Int4),
    oxm_fields.OpenFlowBasic('iptables_index', 70, type_desc.Int4),
] + nx_match.oxm_types
...
# enum iptables action type
IPTABLES_TYPE_NONE = 0
IPTABLES_PREROUTING = 1
IPTABLES_INPUT = 2
IPTABLES_OUTPUT = 3
IPTABLES_FORWARD = 4
IPTABLES_POSTROUTING = 5

# enum iptables action description
IPTABLES_DESC_NONE = 0
IPTABLES_ACCEPT = 1
IPTABLES_DROP = 2
IPTABLES_QUEUE = 3
IPTABLES_RETURN = 4
